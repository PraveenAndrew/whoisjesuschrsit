       ...
       function getJohn()
       {
              ...
              if(x.readyState == 4 && x.status == 200)
              {
                     ...
                     for(var i=0;i<o.length;i++)
                     {
                           ...
                           o[i]["chapter"] == 11 || o[i]["chapter"] == 12 ||o[i]["chapter"] == 13  || o[i]["chapter"] == 14 || o[i]["chapter"] == 15 || o[i]["chapter"] == 16 || o[i]["chapter"] == 17 || o[i]["chapter"] == 18 || o[i]["chapter"] == 19 || o[i]["chapter"] == 20 || o[i]["chapter"] == 21)
                           {
